  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-500 print:max-w-none print:m-0 print:p-0">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex bg-surface-container-low rounded-lg p-1 print:hidden" role="group" aria-label="Time period filter">
          {(['7d', '30d', 'all'] as const).map((filter) => (
            <button
              ...
              className={`px-4 py-1.5 text-sm font-medium rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${
                timeFilter === filter 
        ...
        <div className="p-8 flex flex-col md:flex-row gap-8 relative z-10">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-primary/20 p-2 rounded-xl shrink-0" aria-hidden="true">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-1.5 bg-surface px-3 py-1.5 rounded-full border border-outline-variant text-sm font-medium text-on-surface shadow-sm">
                {trendIsPositive ? <TrendingUp size={16} className="text-primary" aria-hidden="true" /> : <TrendingUp size={16} className="text-error rotate-180" aria-hidden="true" />}
              ...
              {user.achievementsEarned > 0 && (
                <div className="flex items-center gap-1.5 bg-surface px-3 py-1.5 rounded-full border border-outline-variant text-sm font-medium text-on-surface shadow-sm">
                  <Trophy size={16} className="text-tertiary" aria-hidden="true" />
      ...
      <section className="grid grid-cols-1 lg:grid-cols-5 gap-6 print:break-inside-avoid">
        <div className="lg:col-span-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 h-[calc(100%-2.5rem)]">
            <Card className="p-5 sm:p-6 flex flex-col justify-between hover:bg-surface-container-low transition-colors group cursor-default">
              <div className="mb-2">
                <div className="bg-green-500/10 text-green-600 dark:text-green-400 w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform mb-3" aria-hidden="true">
                  <Activity size={20} />
                </div>
                <h3 className="text-xs sm:text-sm font-bold text-on-surface-variant m-0 p-0">Total Actions</h3>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-on-surface mb-0.5">{kpiMetrics.actions}</p>
                <p className="text-[10px] sm:text-xs text-on-surface-variant/80">Completed actions</p>
              </div>
            </Card>
            <Card className="p-5 sm:p-6 flex flex-col justify-between hover:bg-surface-container-low transition-colors group cursor-default">
              <div className="mb-2">
                <div className="bg-teal-500/10 text-teal-600 dark:text-teal-400 w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform mb-3" aria-hidden="true">
                  <TreePine size={20} />
                </div>
                <h3 className="text-xs sm:text-sm font-bold text-on-surface-variant m-0 p-0">Carbon Saved</h3>
              </div>
              <div>
                <div className="flex items-baseline gap-1 mb-0.5">
                  <p className="text-2xl sm:text-3xl font-bold text-on-surface">{kpiMetrics.carbon.toFixed(1)}</p>
            ...
            <Card className="p-5 sm:p-6 flex flex-col justify-between hover:bg-surface-container-low transition-colors group cursor-default">
              <div className="mb-2">
                <div className="bg-orange-500/10 text-orange-600 dark:text-orange-400 w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform mb-3" aria-hidden="true">
                  <Flame size={20} />
                </div>
                <h3 className="text-xs sm:text-sm font-bold text-on-surface-variant m-0 p-0">Longest Streak</h3>
              </div>
              <div>
                <div className="flex items-baseline gap-1 mb-0.5">
                  <p className="text-2xl sm:text-3xl font-bold text-on-surface">{kpiMetrics.streak}</p>
            ...
            <Card className="p-5 sm:p-6 flex flex-col justify-between hover:bg-surface-container-low transition-colors group cursor-default">
              <div className="mb-2">
                <div className="bg-amber-500/10 text-amber-600 dark:text-amber-400 w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform mb-3" aria-hidden="true">
                  <Star size={20} />
                </div>
                <h3 className="text-xs sm:text-sm font-bold text-on-surface-variant m-0 p-0">Total XP</h3>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-on-surface mb-0.5">{kpiMetrics.xp.toLocaleString()}</p>
        ...
        <div className="lg:col-span-2">
          ...
          <Card className="p-6 h-[calc(100%-2.5rem)] flex flex-col relative overflow-hidden bg-surface-container-lowest justify-between">
            <div className="absolute -right-4 -top-4 text-on-surface opacity-[0.03] dark:text-teal-500 dark:opacity-10 pointer-events-none z-0" aria-hidden="true">
            ...
            <div className="relative z-10 mt-auto pt-4">
              <div className="space-y-3 mb-6">
                <div className="flex justify-between text-sm font-medium items-end" aria-hidden="true">
                ...
                <div className="h-3 w-full bg-surface-container-high rounded-full overflow-hidden" role="progressbar" aria-valuenow={Math.min(user.xp, user.nextLevelXp)} aria-valuemin={0} aria-valuemax={user.nextLevelXp} aria-label="Level Progress">
                  <div 
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 print:block">
        <Card className="p-4 md:p-6 flex flex-col h-[300px] md:h-[380px] print:mb-6 print:break-inside-avoid">
          ...
          <div className="flex-1 min-h-0 w-full relative" aria-label="Activity Trends Chart" role="img">
            {emptyHistory ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 text-on-surface-variant bg-surface-container-lowest/50 rounded-xl border border-dashed border-outline-variant">
                <Activity size={32} className="mb-3 text-outline" aria-hidden="true" />
        ...
        <Card className="p-6 flex flex-col h-[300px] md:h-[380px] print:break-inside-avoid">
          ...
          <div className="flex-1 min-h-0 w-full relative" aria-label="Consistency Score Chart" role="img">
            {emptyHistory ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 text-on-surface-variant bg-surface-container-lowest/50 rounded-xl border border-dashed border-outline-variant">
                <TrendingUp size={32} className="mb-3 text-outline" aria-hidden="true" />
      ...
      <section>
        ...
        {!highlights ? (
           <Card className="p-8 text-center text-on-surface-variant flex flex-col items-center justify-center border-dashed border-outline-variant">
             <Leaf size={40} className="mb-4 text-outline" aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="p-5 flex items-start gap-4 hover:bg-surface-container-low transition-colors group cursor-default">
              <div className="bg-primary/10 p-3 rounded-full text-primary group-hover:scale-110 transition-transform" aria-hidden="true">
                <Award size={20} />
              </div>
              <div>
                <h3 className="text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-1 m-0 p-0">Most Completed Habit</h3>
            ...
            <Card className="p-5 flex items-start gap-4 hover:bg-surface-container-low transition-colors group cursor-default">
              ...
              <div>
                <h3 className="text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-1 m-0 p-0">Top Carbon Saver</h3>
            ...
            <Card className="p-5 flex items-start gap-4 hover:bg-surface-container-low transition-colors group cursor-default">
              <div className="bg-tertiary-container text-on-tertiary-container p-3 rounded-full group-hover:scale-110 transition-transform" aria-hidden="true">
                <Zap size={20} />
              </div>
              <div>
                <h3 className="text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-1 m-0 p-0">Highest XP Activity</h3>
